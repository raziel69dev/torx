<template>
  <div class="presentation">
    ...
    <div class="preview">
      <a :href="torxPres" target="_blank">
        <img :src="presPreview" alt="" />
        <svg
          class="link"
          width="20"
          height="20"
